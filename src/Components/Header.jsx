...
const Header = () => {
  return (
    <div className=' main-container  max-[700px]:py-0 py-15 text-white text-center '>
      ...
      <button className=' text-[16px] mt-20 mb-5 max-[700px]:text-[15px] max-[500px]:text-[14px] px-5 py-2 rounded-3xl bg-white/25 backdrop-invert backdrop-opacity-10 my-3 hover:cursor-pointer backdrop-invert backdrop-opacity-1'>100% Transperent</button>
