...
const Header = () => {
  return (
    <div className=' main-container text-white text-center py-[70px]  h-[725px]'>
      <img src={bgheader} alt="" className='-z-10 absolute inset-0 w-full h-full object-cover' />
      <button className=' text-[16px] max-[700px]:text-[15px] max-[500px]:text-[14px] px-5 py-2 rounded-3xl bg-white/25 backdrop-invert backdrop-opacity-10 my-3 hover:cursor-pointer hover:bg-white/90 backdrop-invert backdrop-opacity-1 hover:text-mainBlue  transition-colors duration-300'>100% Transperent</button>
      ...
      <div className='flex gap-2 justify-center py-10 max-[400px]:py-7'>
