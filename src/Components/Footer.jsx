       ...
       <div className='bg-gray-950'>
        <div className='main-container'>
            ...
            <label className='flex justify-between p-1.5 my-3 rounded-3xl text-white text-[17px] max-[700px]:text-[14px] border-white border-[1px] bg-[black] w-[431px] max-[700px]:w-[90%] mx-auto ' >
                <input className=' focus:outline-none focus:border-none w-[65%]' type="text" placeholder='Shark Trading' />
                <Button title="Submit" text={"text-white] hover:text-white text-[16px] max-[573px]:text-[15px] max-[481px]:text-[13px] max-[455px]:text-[11px] "} color={"bg-mainBlue hover:bg-[black]"} icon={rightplay} bg={"bg-[white]"} border={" border-[1px] border-mainBlue hover:border-white"} />
            </label>
